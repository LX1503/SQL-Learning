...
CREATE TABLE suppliers (
    ...
    PRIMARY KEY (supplier_name, coffeeshop_id),
...
-- Insert first 2 entries into employees table
-- set coffeeshop_id to NULL as we have not added coffeeshop values into shops table yet
INSERT INTO employees VALUES (000001, 'Carson', 'Pearson', 'cpearson@abc.edu', '2012-05-28', 'M', 36000, NULL);
INSERT INTO employees VALUES (000002, 'Pearson', 'Carson', 'pcarson@abc.edu', '2012-10-28', 'M', 42000, NULL);

-- Now set coffeeshop_id for the first 2 employees we inserted to 1
UPDATE employees
SET coffeeshop_id = 1
WHERE employee_id IN (000001, 000002);

-- Insert locations table
INSERT INTO location VALUES (1, 'Los Angeles', 'United States');
INSERT INTO location VALUES (2, 'New York', 'United States');
INSERT INTO location VALUES (3, 'London', 'United Kingdom');
...
INSERT INTO suppliers VALUES (2, 'Vanilla Beans', 'Liberica');
...
INSERT INTO suppliers VALUES (3, 'Vanilla Beans', 'Liberica');
INSERT INTO suppliers VALUES (3, 'Cool Beans', 'Robusta');
INSERT INTO suppliers VALUES (3, 'Beans and Barley', 'Arabica');
INSERT INTO suppliers VALUES (4, 'Vanilla Beans', 'Liberica');
INSERT INTO suppliers VALUES (4, 'Bean Me Up', 'Excelsa');
INSERT INTO suppliers VALUES (5, 'Beans and Barley', 'Arabica');
INSERT INTO suppliers VALUES (5, 'Vanilla Beans', 'Liberica');
INSERT INTO suppliers VALUES (5, 'Bean Me Up', 'Excelsa');

-- Insert the shop with coffeeshop_id = 1 into shops table
-- Set city_id to NULL as we have not added city values into locations table yet
INSERT INTO shops VALUES (1, 'Common Grounds', 1);
